...
Geokit::Geocoders::GoogleGeocoder.client_id = 'fresh-entity-124619'
Geokit::Geocoders::GoogleGeocoder.cryptographic_key = 'AIzaSyBE_Y6Bn_WeYp5fe9XTbFaZWQdSlNZSkRE'

# You can also use the free API key instead of signed requests
# See https://developers.google.com/maps/documentation/geocoding/#api_key
Geokit::Geocoders::GoogleGeocoder.api_key = 'AIzaSyBE_Y6Bn_WeYp5fe9XTbFaZWQdSlNZSkRE'
